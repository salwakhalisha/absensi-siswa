...
<div class="md:w-1/2 pl-4 md:pl-12">
      ...
      <div class="flex gap-4">
        <a href="{{route('absen.index')}}" class="bg-cyan-400 text-[#1A0956] font-bold px-6 py-3 rounded-full hover:bg-cyan-300 transition">Absen</a>
        <a href="{{route('absen.riwayat')}}" class="bg-cyan-400 text-[#1A0956] font-bold px-6 py-3 rounded-full hover:bg-cyan-300 transition">Lihat Riwayat Absensi</a>
      </div>
    </div>
